...
class FormKesehatanAwal extends StatefulWidget {
  const FormKesehatanAwal({super.key});

  @override
  State<FormKesehatanAwal> createState() => _FormKesehatanAwalState();
}

class _FormKesehatanAwalState extends State<FormKesehatanAwal> {
  String? beratBadan;
  String? tinggiBadan;
